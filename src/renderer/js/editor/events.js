...
export function setPropertyAsDefaultValue(element, propKey, newValue) {
    ...
    const keyToPath = {
        ...
        beatPoints: { prop: 'beatPoints', valueKey: 'beatPoints' },
        ...
        textStrokeEnabled: { prop: 'textStroke', valueKey: 'enabled' },
        textStrokeWidth: { prop: 'textStroke', valueKey: 'width' },
        textStrokeColor: { prop: 'textStroke', valueKey: 'color' },
